...
def word2vec_pro(textos, freq=None):
    ...
    w2v_model.build_vocab(oraciones_con_bigramas, progress_per=10000)

    w2v_model.train(oraciones_con_bigramas, total_examples=w2v_model.corpus_count, epochs=40, report_delay=1)
